...
/**
 * Demo Sample, modified from this https://github.com/alexa/skill-sample-nodejs-fact
 **/
...
const handlers = {
    ...
    'SayColor': function(){
        ...
        this.emit(':tell', this.t('COLOR_MESSAGE') + '<say-as interpret-as="spell-out">' + color + '</say-as>')
    },
